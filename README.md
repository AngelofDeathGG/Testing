...
Este proyecto esta pensado como base para una aplicacion Node.js. Aqui puedes agregar tu API, servicio, CLI o app web segun lo necesites. Este proyecto es sobre JasaScript. Esta perfecto. Me gusto lo que añadiste. gracias no te preocupes
